...
public class App {
	public static void main(String[] args) {
		...
		String[] fizzbuzzArray=new String [args.length -1];
		int[] kazuArray=new int [args.length -1];
		...
		for (int i = 0, l = args.length-1; i < l; i++) {
			String aaa = args[i];
			    ...
			    int index = aaa.indexOf(":");



			kazuArray[i] = Integer.parseInt (aaa.substring(0,index));
			fizzbuzzArray[i]= aaa.substring(index+1);
		}
